...
depend on the other: :class:`~gmtrack.mdp.commands.MultiMotionCommand` uses it to
decide which motion set an environment samples from, and
:class:`~gmtrack.rsl_rl.storage.StarRolloutStorage` uses it to decide which rollout
