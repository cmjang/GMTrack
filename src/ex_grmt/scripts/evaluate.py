...
from ex_grmt.protocol import validate_evaluation_manifest
from ex_grmt.provenance import PAPER_ID, PAPER_SHA256, sha256_file
...
def main(cfg: Config) -> None:
  ...
  print(
    f"[ex-grmt] evaluating {lib.num_clips} clips x "
