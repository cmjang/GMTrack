...
replayed through :class:`ex_grmt.motion_grounding.G1MotionGrounder`, including its
...
Usage::
    ...
    uv run python -m ex_grmt.scripts.audit_ground_clearance \
...
_SCHEMA = "ex-grmt-ground-clearance-audit"
_SCHEMA_VERSION = 1
